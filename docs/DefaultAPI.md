...
[**healthOptions**](DefaultAPI.md#healthoptions) | **OPTIONS** /health | 
[**productDelete**](DefaultAPI.md#productdelete) | **DELETE** /product | 
[**productGet**](DefaultAPI.md#productget) | **GET** /product | 
[**productOptions**](DefaultAPI.md#productoptions) | **OPTIONS** /product | 
[**productPost**](DefaultAPI.md#productpost) | **POST** /product | 
[**productPut**](DefaultAPI.md#productput) | **PUT** /product | 
[**productsGet**](DefaultAPI.md#productsget) | **GET** /products | 
[**productsOptions**](DefaultAPI.md#productsoptions) | **OPTIONS** /products | 
...
DefaultAPI.healthOptions() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
DefaultAPI.productDelete() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
DefaultAPI.productGet() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
DefaultAPI.productOptions() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
DefaultAPI.productPost() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
DefaultAPI.productPut() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
DefaultAPI.productsGet() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
DefaultAPI.productsOptions() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
DefaultAPI.productsPost() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
